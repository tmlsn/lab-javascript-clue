...
function selectRandom(arr) {
  let posOfSelection = Math.floor(Math.random() * arr.length);
  let cardSelected = arr[posOfSelection];
  return cardSelected
}
...
function pickMystery() {
  let card1 = selectRandom(suspectsArray);
  let card2 = selectRandom(roomsArray);
  let card3 = selectRandom(weaponsArray);
